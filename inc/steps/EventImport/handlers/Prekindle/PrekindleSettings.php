    ...
    public static function get_fields(array $current_config = []): array {
        $handler_fields = [
            'organizer_url' => [
                ...
                'description' => \__('Prekindle organizer event calendar URL (example: https://www.prekindle.com/events/venue-name).', 'datamachine-events'),
                'placeholder' => \__('https://www.prekindle.com/events/hole-in-the-wall', 'datamachine-events'),
                'required' => true,
            ],
        ];
